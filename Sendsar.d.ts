...
export { CALL_LOG_PART_TYPE, formatCallLogPreview, formatCallTimer, isMissedCallLog, parseCallLogPart, type CallLogData, type CallLogOutcome, } from "@sendsar/protocol";
/**
